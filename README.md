...
- **`analyze_results.py`**: Analysis and plotting script
  ...
  - Updated Figure 2 shows all 6 policies with sample distribution by arm group
...
- **Output:** Generates plots in current directory (or `--output-dir`):
  - `figure1_learning_curve.png`: Success probability over time
  - `figure2_allocation_efficiency.png`: Sample distribution by arm group (ALL 6 policies)
  - `figure3_posterior_evolution.png`: Posterior probability evolution
- **Flags:**
  - `--data-dir`: Specify data directory (default: `data/`)
